...
Se sospecha que el modelo que mejor aproxima estos datos es $y = \lambda(1-e^\betax)$. Ahora para este modelo vamos a 
considerar el sistema de ecuaciones: $X\vec{b} = \vec{y}$ donde X es la matriz que cumple
\begin{center}
$ \mathbf{X} = \begin{pmatrix} 1 & e^{\betax_1} \\ 1 & e^{\betax_2} \\ ... & ... \\ 1 & e^{\betax_14} \end{pmatrix} $  
\end{center}
